...
<body style = "background-color: #bae0d6;">
    ...
    <div class = "container-fluid mt-3">
        ...
        <div class = "cartonas_jucator mx-2 mb-3" id = "<?=$cnt?>">
            ...
            <div class = "cartonas_imagine" style = "background-image: url('<?=$imagini_fotbal[$cnt]?>');" alt = "Nimic"></div>
    ...
    <form method = "post" action = "adaugare_vot.php">
        <button class = "btn btn-success " id = "buton_vot" 
        type = "submit" name = "buton_vot"> Votează </button>
